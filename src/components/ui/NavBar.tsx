          ...
          return (
            <button
              ...
              className={cn(
                ...
                isActive && "bg-gray-800/50 text-teal-400",
              )}
            >
              ...
              {isActive && (
                <motion.div
                  layoutId="lamp"
                  className="absolute inset-0 w-full bg-teal-600/10 rounded-full -z-10"
                  initial={false}
                  transition={{
                    type: "spring",
                    stiffness: 300,
                ...
                >
                  <div className="absolute -top-2 left-1/2 -translate-x-1/2 w-8 h-1 bg-teal-400 rounded-t-full">
